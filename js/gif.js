...
changeIMG1[0] = "https://c.tenor.com/f9nZ8i8qWAwAAAAC/disney-zombie-disney-zombies.gif";
changeIMG1[1] = "https://media1.giphy.com/media/CtEH4E31mzF1S/giphy.gif";
changeIMG1[2] = "https://37.media.tumblr.com/6273dcf98ec8b040ab7d201a05ca17fb/tumblr_mr6eleKMXY1rp0vkjo1_500.gif";
...
function cambiar() {
    document.getElementById("randomIMG").src = changeIMG1[Math.floor(Math.random() * 5)];
    document.getElementById("randomIMG2").src = changeIMG2[Math.floor(Math.random() * 5)];
    document.getElementById("randomIMG3").src = changeIMG3[Math.floor(Math.random() * 5)];
